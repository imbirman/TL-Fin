...
public class CreateRequestSteps{
    ...
    @Step("Всплывающая ошибка содержит в себе: Не заполнено поле «Итоговая цена контракта/договора»")
    ...
    @Step("Ввести некорректное значение в поле 'Срок (месяцев)' в блоке 'Исполнение обязательств'")
