...
//        steps.click_button(agentOfficeMenuButton);
    ...
    @Test
    @Title("Проверка количества сотрудников после отмены удаления одного")
    public void checkNumberAddingEmployeesAfterCancelDeletion(){
        ...
        steps.dismiss_alert();
        steps.wait_a_bit();
        steps.check_number_adding_employees_after_cancel_deletion();
        steps.click_button(closeBoxContentAddEmployees);
        steps.delete_adding_department();
    }
